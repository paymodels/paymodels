...
INSERT INTO pm_products (slug, name, price, description, featured, features, sub_price) VALUES
  ('plus',   'ChatGPT Plus 月卡',  189,  '人工充值 · 不成功全额退款', false,
   '["人工充值服务","充值失败全额退款","基础客服支持","标准到账速度"]'::jsonb, NULL),
  ('pro5x',  'ChatGPT Pro 5X',    864,  '性价比之选', true,
   '["5 倍 Plus 额度","Codex 编程支持","优先客服响应","极速到账通道","Stripe 国际支付","微信支付支持"]'::jsonb, '$120/月'),
  ('pro20x', 'ChatGPT Pro 20X',  1620,  '顶级体验', false,
   '["20 倍 Plus 额度","Codex 编程支持","专属客户经理","最高优先级到账","Stripe 国际支付","微信支付支持","API 接口对接","企业级 SLA 保障"]'::jsonb, '$225/月');
